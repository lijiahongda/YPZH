    ...
    <div class="container">
      ...
      <div class="handle-box">
        <!-- <el-radio-group v-model="tabPosition" size="medium" @change="Shsx($event)">
          <el-radio-button label="审核中">充值记录</el-radio-button>
          <el-radio-button label="进行中">提现记录</el-radio-button>
      ...
      >
        ...
        <el-table-column prop="out_biz_no" label="订单号"></el-table-column>
        <el-table-column prop="payee_real_name" label="收款方"></el-table-column>
        <el-table-column prop="payer_show_name" label="收款方姓名"></el-table-column>
        <el-table-column prop="payee_type" label="账户类型"></el-table-column>
        <el-table-column prop="amount" label="金额"></el-table-column>
        <el-table-column prop="chage_integral" label="消耗积分"></el-table-column>
        <el-table-column prop="orderId" label="支付宝订单号"></el-table-column>
...
<script>
import { payGetList } from "@/api/http/recharge.js";
export default {
  name: "cmstype",
  data() {
    return {
