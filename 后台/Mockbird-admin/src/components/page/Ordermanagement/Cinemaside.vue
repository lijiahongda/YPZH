  ...
  <div class="table">
    ...
    <div class="container">
      ...
      >
        ...
        <!-- <el-table-column prop="totalPrices" label="总价格"></el-table-column>
...
<script>
import { searchByOrderList, searchfindOrderId } from "@/api/http/public.js";
export default {
  name: "cmstype",
  data() {
    return {
  ...
  methods: {
    ...
    getList() {
      let _self = this;
      let ustats = 0;
      if (this.tabPosition == "审核中") {
        ustats = 0;
      }
      if (this.tabPosition == "进行中") {
        ustats = 1;
      }
      ...
      searchByOrderList(params).then(res => {
        if (res.status == 200) {
