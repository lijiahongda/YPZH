    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item><i class="el-icon-lx-cascades"></i> 短信历史</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            ...
            <el-table :data="lists" border class="table" ref="multipleTable" @selection-change="selsChange">
                ...
                <el-table-column prop="integralNum" label="积分">
                </el-table-column>
          ...
          <el-dialog title="历史纪录" :visible.sync="addFormVisible" :close-on-click-modal="false">
             <el-table :data="historyList" border class="table" ref="multipleTable" @selection-change="selsChange">
                <el-table-column type="selection" width="55" align="center"></el-table-column>
                <el-table-column prop="id" label="id">
                </el-table-column>
                <el-table-column prop="integralNum" label="积分">
...
<script>
import { integralDetailedList,ConsumptionIntegralj,ConsumptionIntegralja,integralDetailedqueryList } from "@/api/util/public.js";
export default {
  name: "cmstype",
  data() {
    return {
